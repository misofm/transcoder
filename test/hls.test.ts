...
describe("strict HLS processing", () => {
  ...
  test("parses the plaintext media playlist without rewriting it", () => {
    ...
    expect(playlist.mapIdentifier).toBe("aac-96-init.mp4");
  });
  ...
  test.each([
    ...
    ["subdirectory", valid.replace("aac-96-00000.m4s", "sub/aac-96-00000.m4s")],
    ["query", valid.replace("aac-96-00000.m4s", "aac-96-00000.m4s?x=1")],
    ["duplicate", valid.replace("aac-96-00001.m4s", "aac-96-00000.m4s")],
    ...
    [
      "map after media",
      valid
        .replace('#EXT-X-MAP:URI="aac-96-init.mp4"\n', "")
        .replace(
          "aac-96-00000.m4s\n",
          'aac-96-00000.m4s\n#EXT-X-MAP:URI="aac-96-init.mp4"\n',
        ),
